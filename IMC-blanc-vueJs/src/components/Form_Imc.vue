<template>
 ...
 <div>
      ...
      <input type="number" name="taille" id="taille" placeholder="en cm"  min="130" max="220"
        v-model="imc.taille" />
</div>
        <br>
<div class="input-group">
      ...
      <input type="number" name="poids" id="poids" placeholder="en kg"  min="40" max="200"
        v-model="imc.poids" />
        </div>
        <br>
        <br>
   <center>
      <input type="submit" value="Ready or not, here I come! 😱" />
      </center>
      <br><br>
    </form>
  </div>
